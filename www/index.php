...
$strSQL = "select a.intro,b.opicname as pic from layout as a left join layoutpic as b
 on a.id_layout=b.id_layout  where a.id_layout='21' order by b.id_layoutpic desc limit 3" ;
$objDB->Execute($strSQL);
$adv_A1=$objDB->GetRows();
$adv_A1_title=explode("|",$adv_A1[0][intro]);     //分割出标题

//首页通栏栏广告
$strSQL = "select opicname as pic from  layoutpic where id_layout='22' order by id_layoutpic desc limit 1" ;
$objDB->Execute($strSQL);
$adv_A2=$objDB->fields();

//首页左下角广告
$strSQL = "select a.intro,a.url,b.opicname as pic from layout as a left join layoutpic as b
 on a.id_layout=b.id_layout  where a.id_layout='23' order by b.id_layoutpic desc limit 1" ;
$objDB->Execute($strSQL);
$adv_A3=$objDB->fields();

//首页下居中广告A
$strSQL = "select a.content,a.url,b.opicname as pic from layout as a left join layoutpic as b
 on a.id_layout=b.id_layout  where a.id_layout='24' order by b.id_layoutpic desc limit 1" ;
$objDB->Execute($strSQL);
$adv_A4=$objDB->fields();

//首页下居中广告B
$strSQL = "select a.content,a.url,b.opicname as pic from layout as a left join layoutpic as b
 on a.id_layout=b.id_layout  where a.id_layout='25' order by b.id_layoutpic desc limit 1" ;
$objDB->Execute($strSQL);
$adv_A5=$objDB->fields();
...
<div id="content3">
  ...
  <div id="content3_l1r" class='txt_01'><img src="inc/pics/icon001ch.gif" /><br /><br />
<?php echo $adv_A3[intro];?>  <a href="<?php echo $adv_A3[url];?>" class="link_noline"><img src="inc/pics/icon002.gif" border="0"/></a>
  ...
  <div id="content3_r">
  <div id="content3_r_news01"><img src="inc/pics/news01ch.gif" /></div>
