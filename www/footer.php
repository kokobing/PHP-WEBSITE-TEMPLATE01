<?php
//页脚
$strSQL = "select content from layout  where id_layout='26'" ;
...
<!-- JiaThis Button END -->
          ...
          <!-- 广告 -->    
         <script src="/adv_/jquery.js" type="text/javascript"></script> 
        <script src="/adv_/jquery.alerts.js" type="text/javascript"></script>
		<link href="/adv_/jquery.alerts.css" type=text/css rel=stylesheet />  
        <script src="/adv_/adv_.js" type="text/javascript"></script>