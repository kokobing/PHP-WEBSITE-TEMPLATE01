...
stm_aix("p0i1","p0i0",[0,"<? $arrmenu1_ch=explode("----",$arrmenu1[0][name]);echo $arrmenu1_ch[0];?>","","",-1,-1,0,"<?=$arrmenu1[0][url];?>","_self","","","","",0,0,0,"","",0,0,0,1,1,"#498E11",1,"<?=$stylecolor;?>",0,"/inc/pics/menu3-1.gif","/inc/pics/menu3-2.gif",3,3,0,0,"#CCCCCC","#CCCCCC","#6E6767","#ffffff","12pt Arial","12pt Arial"],115,74);
...
stm_aix("p0i3","p0i1",[0,"<? $arrmenu1_ch=explode("----",$arrmenu1[1][name]);echo $arrmenu1_ch[0];?>","","",-1,-1,0,"<?=$arrmenu1[1][url];?>"],115,74);
<?
//WEBMENU 2 级目录
...
stm_aix("p2i1","p0i0",[0,"  <? $arrmenu2_ch=explode("----",$arrmenu2[0][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[0][url];?>","_self","","","","",5,5,0,"","",0,0,0,0,1,"#FFFFF7",1,"<?=$stylebg5;?>",0,"","",3,3,0,0,"#FFFFF7","#000000","#FFF","#FFFFFF","bold 9pt Arial","bold 9pt Arial"],84,38);
stm_aix("p2i2","p2i1",[0,"  <? $arrmenu2_ch=explode("----",$arrmenu2[1][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[1][url];?>"],80,38);
stm_aix("p2i3","p2i1",[0,"<? $arrmenu2_ch=explode("----",$arrmenu2[2][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[2][url];?>"],110,38);
...
stm_aix("p0i5","p0i1",[0,"<? $arrmenu1_ch=explode("----",$arrmenu1[2][name]);echo $arrmenu1_ch[0];?>","","",-1,-1,0,"<?=$arrmenu1[2][url];?>"],115,74);
stm_bpx("p3","p2",[0,4,-446]);
stm_aix("p3i0","p2i0",[0,"","","",-1,-1,0,"#"],446,38);
stm_aix("p3i1","p2i1",[0,"     <? $arrmenu2_ch=explode("----",$arrmenu2[0][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[0][url];?>"],65,38);
stm_aix("p3i2","p2i1",[0,"     <? $arrmenu2_ch=explode("----",$arrmenu2[1][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[1][url];?>"],100,38);
stm_aix("p3i3","p2i1",[0," <? $arrmenu2_ch=explode("----",$arrmenu2[2][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[2][url];?>"],100,38);
...
stm_aix("p0i7","p0i1",[0,"<? $arrmenu1_ch=explode("----",$arrmenu1[3][name]);echo $arrmenu1_ch[0];?>","","",-1,-1,0,"<?=$arrmenu1[3][url];?>"],115,74);
stm_bpx("p4","p2",[0,4,-571]);
stm_aix("p4i0","p3i0",[],571,38);
stm_aix("p4i1","p2i1",[0,"   <? $arrmenu2_ch=explode("----",$arrmenu2[0][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[0][url];?>"],100,38);
stm_aix("p4i2","p2i1",[0,"   <? $arrmenu2_ch=explode("----",$arrmenu2[1][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[1][url];?>"],100,38);
stm_aix("p4i3","p2i1",[0,"   <? $arrmenu2_ch=explode("----",$arrmenu2[2][name]);echo $arrmenu2_ch[0];?>","","",-1,-1,0,"<?=$arrmenu2[2][url];?>"],70,38);
stm_aix("p4i4","p3i0",[],124,38);
stm_ep();

stm_aix("p0i8","p0i2",[],10,74);
stm_aix("p0i9","p0i1",[0,"<? $arrmenu1_ch=explode("----",$arrmenu1[4][name]);echo $arrmenu1_ch[0];?>","","",-1,-1,0,"<?=$arrmenu1[4][url];?>"],115,74);
...
<div id="headerlang"><a href="/" class="link_lang">中文</a> <span class="txt">|</span> <a href="/en/" class="link_lang">English</a></div>
<div id="search">
...
<div id="btn"><a href="javascript:document.searchform.submit();"><span><img src="/inc/pics/<?=$stylebg3;?>" style="border:0" alt="搜索一下"/></span></a></div>
</div>
