...
<div id="inner_contentinner_right3" class='txt'>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><?php if($_GET[id]=='18'){?><strong>加入我们</strong><?php }else{?><strong>产品新闻 / 公司新闻</strong><? }?></td>
    </tr>
    <tr>
      ...
      <?php }else{?>
        ...
        <tr>
          ...
          <td width="83" align="left" valign="bottom"><?php if(isset($_GET[id])&&$_GET[id]=='4'){?><a href="/news/news.php?id=4"><img src="../inc/pics/icon0131.gif"  border="0" /></a><?php }else{?><a href="/news/news.php?id=4"><img src="../inc/pics/icon013.gif"  border="0" /></a><? }?></td>
          <td align="left" valign="bottom"><?php if(isset($_GET[id])&&$_GET[id]=='3'){?><a href="/news/news.php?id=3"><img src="../inc/pics/icon0141.gif"  border="0" /></a><?php }else{?><a href="/news/news.php?id=3"><img src="../inc/pics/icon014.gif" border="0" /></a><? }?></td>
        </tr>
      </table>
