...
//news
$strSQL = "select * from newsinfo  where id_newsdir='16' and dele=1 order by id_newsinfo desc limit 4" ;
$objDB->Execute($strSQL);
$arrcompanynews=$objDB->GetRows();

$strSQL = "select * from newsinfo  where id_newsdir='17' and dele=1 order by id_newsinfo desc limit 4" ;
$objDB->Execute($strSQL);
...
$intRows = 9;
$strSQLNum = "SELECT COUNT(*) as num from newsinfo as a left join newsdir as b   on a.id_newsdir=b.id_newsdir  where b.lang=1 and a.dele=1 and a.id_newsdir!=18";   
...
$strSQL = "select a.*,b.lang from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where b.lang=1 and a.dele=1 and a.id_newsdir!=18 order by a.id_newsinfo desc" ;
...
//取最后一条新闻，放入左侧NEWS中
$strSQL = "select title,newsdate,id_newsdir,id_newsinfo from newsinfo where id_newsdir='16' or id_newsdir='17' order by newsdate desc limit 1" ;
$objDB->Execute($strSQL);
$adv_A7=$objDB->fields();
...
<link href="../inc/css/csscn.css" rel="stylesheet" type="text/css">
...
<div id="inner_contentinner_left3news01"><img src="../inc/pics/news01ch.gif" /></div>
<div id="inner_contentinner_left3news02">
<div id="inner_contentinner_left3news02u" class="txt_01">
<p>

<a href="/news/newspage.php?id=<?=$adv_A7[id_newsdir];?>&newsid=<?php echo $adv_A7[id_newsinfo];?>" class="link_03"><?php echo cutstr($adv_A7[title],20,1);?></a><br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="txt">
  <tr>
    <td height="30" align="left" class="txt_01"> 首页 &gt;新闻中心 &gt; <span class="txt_02">新闻中心</span></td>
  </tr>
  <tr>
...
<div id='inner_contentinner_right_news1L'>
  ...
  <?php for($i=0;$i<sizeof($arrproductnews);$i++){?>
    <tr>
      <td width="70%"><a href="/news/newspage.php?id=<?php echo $arrproductnews[$i][id_newsdir];?>&newsid=<?php echo $arrproductnews[$i][id_newsinfo];?>" class="link_04"><?php echo cutstr($arrproductnews[$i][title],30,0);?></a></td>
...
<div id='inner_contentinner_right_news1R'>
  ...
  <?php for($i=0;$i<sizeof($arrcompanynews);$i++){?>
    <tr>
      <td width="70%"><a href="/news/newspage.php?id=<?php echo $arrcompanynews[$i][id_newsdir];?>&newsid=<?php echo $arrcompanynews[$i][id_newsinfo];?>" class="link_04"><?php echo cutstr($arrcompanynews[$i][title],30,0);?></a></td>
...
<div id="inner_contentinner_right3" class='txt'>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><?php if($_GET[id]=='7'){?><strong>加入我们</strong><?php }else{?><strong>产品新闻 / 公司新闻</strong><? }?></td>
    </tr>
    <tr>
      ...
      <table width="300" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="83" align="left" valign="bottom"><img src="../inc/pics/icon0151ch.gif" width="83" height="30" /></td>
      ...
      <?php }else{?>
            <table width="300" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="83" align="left" valign="bottom"><?php if(!isset($_GET[id])|| $_GET[id]==''){?><a href="/news/news.php"><img src="../inc/pics/icon012.gif" border="0" /></a><?php }else{?><a href="/news/news.php"><img src="../inc/pics/icon0121.gif"  border="0" /></a><?php }?></td>
          <td width="83" align="left" valign="bottom"><?php if(isset($_GET[id])&&$_GET[id]=='17'){?><a href="/news/news.php?id=17"><img src="../inc/pics/icon0131ch.gif"  border="0" /></a><?php }else{?><a href="/news/news.php?id=17"><img src="../inc/pics/icon013ch.gif"  border="0" /></a><? }?></td>
          <td align="left" valign="bottom"><?php if(isset($_GET[id])&&$_GET[id]=='16'){?><a href="/news/news.php?id=16"><img src="../inc/pics/icon0141ch.gif"  border="0" /></a><?php }else{?><a href="/news/news.php?id=16"><img src="../inc/pics/icon014ch.gif" border="0" /></a><? }?></td>
        </tr>
      </table>
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="txt">
        ...
        <tr>
          ...
          <td align="center" valign="middle"><?php if($arrnews[$i][id_newsdir]=='16'){echo '<img src="../inc/pics/icon016.gif" width="55" height="20" />';}elseif($arrnews[$i][id_newsdir]=='17'){echo '<img src="../inc/pics/icon015.gif" width="55" height="20" />';}elseif($arrnews[$i][id_newsdir]=='7'){echo '<img src="../inc/pics/icon017.gif" width="55" height="20" />';}?>            </td>
          <td align="left" valign="middle"><a href="/news/newspage.php?id=<?php echo $arrnews[$i][id_newsdir];?>&newsid=<?php echo $arrnews[$i][id_newsinfo];?>" class="link_04"><?php echo cutstr($arrnews[$i][title],50,1);?></a></td>
