...
//取出产品一级目录信息
$strSQL="SELECT id_proddir,name FROM productdir WHERE level='1' and dele='1' and lang='1' order by ordernum ASC";
$objDB->Execute($strSQL);
$arrnewsdir1=$objDB->GetRows();
?>
<table width="180" border="0" align="center" cellpadding="3" cellspacing="3" class="txt">
  <tr>
    <td><a href="products.php" <?php if($c_filename=='products.php'){echo 'class="link_04_1"';}else{echo 'class="link_04"';} ?> >产品中心</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="productpdf.php" <?php if($c_filename=='productpdf.php'){echo 'class="link_04_1"';}else{echo 'class="link_04"';} ?>>资料下载</a></td>
  </tr>
  <tr>
    <td><a href="ourfactory.php" <?php if($c_filename=='ourfactory.php'){echo 'class="link_04_1"';}else{echo 'class="link_04"';} ?>>我们的工厂</a></td>
  </tr>
</table>
