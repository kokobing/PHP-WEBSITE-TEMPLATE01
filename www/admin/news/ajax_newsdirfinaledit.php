...
require "../inc/config_perm_ajax.php";//一级目录和二级文件的访问权限判断
  if($ajax_onuserperm_editprem=='1'){
   ...
   if ($isdel=='1' && $ajax_onuserperm_deleprem=='1'){
   	$strSQL="update newsdir set dele='0' where id_newsdir='".$newsid."' and id_newsdir not in (1,3,4,5,6,7,15,16,17,18)";
  ...
  if($newsid==1||$newsid==3||$newsid==4||$newsid==5||$newsid==6||$newsid==7||$newsid==15||$newsid==16||$newsid==17||$newsid==18){
